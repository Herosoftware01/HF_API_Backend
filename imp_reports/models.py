...
class MasWorklist(models.Model):
    id = models.AutoField(db_column='ID', primary_key=True)  # Field name made lowercase.
    description = models.CharField(db_column='Description', max_length=255, db_collation='Latin1_General_CI_AI')  # Field name made lowercase.
    type = models.CharField(db_column='Type', max_length=100, db_collation='Latin1_General_CI_AI')  # Field name made lowercase.
    active_inactive = models.BooleanField(db_column='Active_Inactive')  # Field name made lowercase.
